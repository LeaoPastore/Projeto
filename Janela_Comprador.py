...
from testeprojeto.Dados_Carro import Dados_Carro
...
class Janela_Comprador(Toplevel):
    ...
    def __init__(self, parent):
        ...
        self.lbl_comprador = Label(self, width=20, text='Nome do Comprador')
    ...
    def cadastro_carro(self):
        ...
        print('Nome:', self.txt_comprador.get())
        print('CPF:', self.txt_cpf.get())
